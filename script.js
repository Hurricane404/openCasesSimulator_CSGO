...
this.itemsAdd("AUG | Contractor", "https://steamcommunity-a.akamaihd.net/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot6-iFBRv7OPFcgJK6d2gjb-HluXzNvWEzm5X7Jx02LGZrdut2wy3rxA_NjuiIYCSJlBsZFmEq1W4w-i9g5O1ot2XnvjLm6nU/360fx360f", 0, 0.1)
this.itemsAdd("AUG | Sweeper", "https://steamcommunity-a.akamaihd.net/economy/image/-9a81dlWLwJ2UUGcVs_nsVtzdOEdtWwKGZZLQHTxDZ7I56KU0Zwwo4NUX4oFJZEHLbXH5ApeO4YmlhxYQknCRvCo04DEVlxkKgpot6-iFBRw7P7NYjV9_92wkZSSlfv1MLDum25V4dB8teXA54vwxg2y8hJkNWvxJYGReg4_N1mB-VC8xr3mhcftvM-dn3Bq6Cggty3VnRGpwUYblAKYImM/360fx360f", 2, 0.1)
  ...
  methods: {
    ...
    openCases(){
      ...
      if(itemRaro >= 0 && itemRaro <= 40){
        ...
        while(this.newItems[itemRandom].preco >= 100 && this.newItems[itemRandom].preco <= 300){
        var itemRandom = Math.floor(Math.random() * 30)
        }
      }
      this.gainedItem = {
